...
public static class Program
{
	...
	public static async Task Main(string[] args)
	{
		...
		builder.Services.AddCarltonTestLab(builder =>
		{
			...
			.AddComponentState<ToggleSelect<int>>("FirstOptionSelected", ToggleTestStates.FirstOptionSelected)
			.AddComponentState<ToggleSelect<int>>("SecondOptionSelected", ToggleTestStates.SecondOptionSelected)
