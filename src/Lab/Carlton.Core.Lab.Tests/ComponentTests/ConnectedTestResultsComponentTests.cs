    ...
    private static string BuildExpectedMarkup(IEnumerable<TestResult> testResults)
    {
        var tests = string.Join(Environment.NewLine, testResults.Select(_ =>
             ...
             <div class=""table-row"">
                ...
                <div class=""table-cell"">{_.TestName}</div>
                <div class=""table-cell"">{_.TestDuration}</div>
             </div>"));
...
<div class=""test-results-viewer"">
    <div class=""table-container"">
        <div class=""table-row"">
        <div class=""header-cell table-cell ascending heading-0"">
        ...
        <div class=""header-cell table-cell ascending heading-1"">
        ...
        <div class=""header-cell table-cell ascending heading-2"">
