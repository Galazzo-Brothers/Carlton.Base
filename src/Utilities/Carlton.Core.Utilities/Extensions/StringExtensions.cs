...
public static class StringExtensions
{
	...
	/// <summary>
	/// Normalizes line breaks in the specified string by replacing all occurrences of
	/// Windows-style line breaks ("\r\n") and classic Mac OS-style line breaks ("\r")
	/// with Unix/Linux-style line breaks ("\n").
	/// </summary>
	/// <param name="input">The string in which to normalize line breaks.</param>
	/// <returns>
	/// A new string with all line breaks normalized to Unix/Linux-style line breaks ("\n").
	/// </returns>
