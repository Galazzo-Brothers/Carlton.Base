...
/// </summary>
internal sealed class ModalState : IModalState
{
	/// <summary>
	...
	/// </summary>
	public string ModalType { get; private set; }
	...
	public void RaiseModal(string modalType, ModalViewModel modalViewModel)
	{
		IsVisible = true;
		ModalType = modalType;
