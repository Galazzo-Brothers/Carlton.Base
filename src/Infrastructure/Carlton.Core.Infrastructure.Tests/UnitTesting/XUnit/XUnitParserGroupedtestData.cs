...
{
    //Category 1
    public readonly static IEnumerable<TestResultModel> ExpectedCategory_1_Results = new List<TestResultModel>
    {
    ...
    public readonly static TestResultsReportModel ExpectedCategory_1_Report = new(ExpectedCategory_1_Results);

    //Category 2
    public readonly static IEnumerable<TestResultModel> ExpectedCategory_2_Results = new List<TestResultModel>
    {
        new TestResultModel(XUnitParserSampleSource.TestName_1, XUnitParserSampleSource.TestOutcome_1, XUnitParserSampleSource.Duration_1),
        new TestResultModel(XUnitParserSampleSource.TestName_2, XUnitParserSampleSource.TestOutcome_2, XUnitParserSampleSource.Duration_2)
    };
    public readonly static TestResultsReportModel ExpectedCategory_2_Report = new(ExpectedCategory_2_Results);

    //Category 3
    public readonly static IEnumerable<TestResultModel> ExpectedCategory_3_Results = new List<TestResultModel>
    {
    ...
    public readonly static TestResultsReportModel ExpectedCategory_3_Report = new(ExpectedCategory_3_Results);

    //Default
    public readonly static IEnumerable<TestResultModel> ExpectedCategory_Default_Results = new List<TestResultModel>
    {
    ...
    public readonly static TestResultsReportModel ExpectedCategory_Default_Report = new(ExpectedCategory_Default_Results);

    public readonly static IReadOnlyDictionary<string, TestResultsReportModel> ExpectedGroups = new Dictionary<string, TestResultsReportModel>
    {
