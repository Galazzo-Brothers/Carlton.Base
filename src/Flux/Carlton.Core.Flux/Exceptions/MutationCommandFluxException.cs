...
public class MutationCommandFluxException<TState, TCommand> : FluxException
{
    ...
    {
        var message = $"{FluxLogs.Mutation_Validation_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_Validation_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_HTTP_JSON_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_HttpInterception_Response_JSON_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_HTTP_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_HttpInterception_Request_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_HTTP_URL_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_HttpInterception_UrlConstruction_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_HTTP_Response_Update_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_HttpInterception_Response_Update_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_Apply_Error} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_Apply_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_LocalStorage_JSON_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_SaveLocalStorage_JSON_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_LocalStorage_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_SaveLocalStorage_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{FluxLogs.Mutation_Unhandled_ErrorMsg} {context.CommandTypeName}";
        return new MutationCommandFluxException<TState, TCommand>(FluxLogs.Mutation_Unhandled_Error, message, context, innerException);
    }
