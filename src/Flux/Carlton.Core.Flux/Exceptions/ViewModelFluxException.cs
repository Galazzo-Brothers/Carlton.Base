...
public class ViewModelFluxException<TState, TViewModel> : FluxException
{
    ...
    {
        var message = $"{LogEvents.ViewModel_Validation_ErrorMsg} {context.ViewModelTypeName}";
    ...
    {
        var message = $"{LogEvents.ViewModel_JSON_ErrorMsg} {context.ViewModelTypeName}";
    ...
    {
        var message = $"{LogEvents.ViewModel_HTTP_ErrorMsg} {context.ViewModelTypeName}";
    ...
    {
        var message = $"{LogEvents.ViewModel_HTTP_URL_ErrorMsg} {context.ViewModelTypeName}";
        return new ViewModelFluxException<TState, TViewModel>(LogEvents.ViewModel_HTTP_Request_Error, message, context, innerException);
    }
    ...
    {
        var message = $"{LogEvents.ViewModel_Unhandled_ErrorMsg} {context.ViewModelTypeName}";
