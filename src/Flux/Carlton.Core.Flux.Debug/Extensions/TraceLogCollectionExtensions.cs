...
{
	internal static int GetIndex(this IEnumerable<TraceLogMessageGroup> groups, TraceLogMessageDescriptor log)
	{
		var index = 0;
	...
	internal static TraceLogMessageDescriptor? GetElementAtIndex(this IEnumerable<TraceLogMessageGroup> groups, int targetIndex)
	{
