...
/// </summary>
/// <param name="SelectedTraceLogMessage">The index of the selected trace log message.</param>
...
public record TraceLogMessageExpansionChangedArgs(TraceLogMessageDescriptor TraceLogMessage, bool IsExpanded);
