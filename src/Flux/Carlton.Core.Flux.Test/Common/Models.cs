...
public record TestCommand1([property: NonNegativeInteger] int Id, [property: HttpResponseProperty("ServerName")] string Name, [property: HttpResponseProperty("ServerDescription")] string Description);
